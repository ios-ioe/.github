...
- **Research Team** → Identifies real Nepali problems (education, healthcare, agriculture, government transparency, etc.) through market research, needs assessment, trend analysis, and competitive studies.
- **Developers Team** → Builds, maintains, documents, and releases open-source tools collaboratively (GitHub, PyPI) with best practices in code quality, testing, and continuous improvement.
- **Event Organizers Team** → Plans workshops, hackathons, bootcamps, and awareness programs (virtual/in-person) with speakers, logistics, and community engagement.
- **Social Media / Advertisement Team** → Manages our online presence, creates content, grows the community, and builds partnerships across platforms.
...
## Our Repositories
Here you'll find:
- Research reports & problem statements
- Open-source tools solving Nepali challenges
- Event resources & educational content
- Community guidelines & templates

**Pinned repositories** will showcase our flagship projects!

## Values
- **Open & Inclusive** — Everyone is welcome
